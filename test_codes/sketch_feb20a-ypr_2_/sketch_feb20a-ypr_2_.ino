...
double setpoint= 183; //set the value when the bot is perpendicular to ground using serial monitor. 
//Read the project documentation on circuitdigest.com to learn how to set these values
double Kp = 35; //Set this first
...
void loop() {
    ...
    while (!mpuInterrupt && fifoCount < packetSize)
    {
        ...
        if (input>15 && input<550){//If the Bot is falling 
